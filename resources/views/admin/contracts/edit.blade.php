                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('condominium') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="condominium_id" id="condominium_id" required>
                                @foreach($condominia as $id => $condominium)
                                    <option value="{{ $id }}" {{ (old('condominium_id') ? old('condominium_id') : $contract->condominium->id ?? '') == $id ? 'selected' : '' }}>{{ $condominium }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $contract->first_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $contract->last_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('ssn') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ssn" id="ssn" value="{{ old('ssn', $contract->ssn) }}" required>
                            @if($errors->has('ssn'))
                        ...
                        <div class="form-group {{ $errors->has('register') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="register" id="register" value="{{ old('register', $contract->register) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('birth_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date', $contract->birth_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $contract->phone) }}">
                            @if($errors->has('phone'))
                        ...
                        <div class="form-group {{ $errors->has('mobile_phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mobile_phone" id="mobile_phone" value="{{ old('mobile_phone', $contract->mobile_phone) }}">
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $contract->email) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('zipcode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="zipcode" id="zipcode" value="{{ old('zipcode', $contract->zipcode) }}">
                        ...
                        <div class="form-group {{ $errors->has('address_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address_1" id="address_1" value="{{ old('address_1', $contract->address_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('address_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address_number" id="address_number" value="{{ old('address_number', $contract->address_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('province') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="province" id="province" value="{{ old('province', $contract->province) }}">
                        ...
                        <div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $contract->city) }}">
                            @if($errors->has('city'))
                        ...
                        <div class="form-group {{ $errors->has('state') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $contract->state) }}">
                            @if($errors->has('state'))
                        ...
                        <div class="form-group {{ $errors->has('address_complement') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address_complement" id="address_complement" value="{{ old('address_complement', $contract->address_complement) }}">
