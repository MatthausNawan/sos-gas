...
class ContractController extends Controller
{
    ...
    public function create()
    {
        ...
        $condominia = Condominium::all()->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.contracts.create', compact('condominia'));
    }
    ...
    public function edit(Contract $contract)
    {
        ...
        $contract->load('condominium');

        return view('admin.contracts.edit', compact('condominia', 'contract'));
    }
